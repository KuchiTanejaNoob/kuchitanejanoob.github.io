...
objects[0] = {obj: test, text: 'Programmer'};
objects[1] = {obj: test2, text: 'AI enthusiast'};
objects[2] = {obj: test3, text: 'Designer'};
objects[3] = {obj: test4, text: 'Back-end Developer'};
objects[4] = {obj: test5, text: 'Entrepreneur'};
objects[5] = {obj: test6, text: 'Learner'};
...
loader.load('/TheRock2.obj', function (object) {
    ...
    // objects.push(object);
    objects[0] = {obj: object, text: 'Programmer'};
...
loader.load('/micro.obj', function (object) {
    ...
    object.visible = false;
    // objects.push(object);
    objects[1] = {obj: object, text: 'AI enthusiast'};
    scene.add(object);
    animate()
}, onProgress, onError);
...
group.add(cube2);
group.visible = false;
objects[2] = {obj: group, text: 'Designer'};
scene.add(group);
...
loader.load('/suitcase.obj', function (object) {
    ...
    object.rotation.z = .2;
    object.visible = false;
    objects[3] = {obj: object, text: 'Back-end Developer'};
    scene.add(object);
    animate()
}, onProgress, onError);
...
loader.load('/cup.obj', function (object) {
    ...
    object.visible = false;
    // objects.push(object);
    objects[4] = {obj: object, text: 'Entrepreneur'};
    scene.add(object);
    animate()
}, onProgress, onError);
...
group.add(sphere2);
group.visible = false;
objects[5] = {obj: group, text: 'Learner'};
scene.add(group);
